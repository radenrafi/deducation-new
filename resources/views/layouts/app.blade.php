        ...
        <nav class="navbar navbar-expand-md shadow-sm custom-nav">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{asset('img/welcome/logo text.png')}}" alt="" sizes="" srcset="" />
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @yield('menuDonasi')" href="/donasi">Donasi</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @yield('menuArtikel')" href="/artikel">Artikel</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @yield('menuPengajuanTempat')" href="/pengajuanTempat">Pengajuan Tempat</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @yield('menuRiwayatDonasi')" href="/riwayatDonasi">Riwayat</a>
                        </li>
                    </ul>
